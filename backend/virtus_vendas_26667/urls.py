"""virtus_vendas_26667 URL Configuration
...
admin.site.site_title = "Virtus Vendas Admin Portal"
admin.site.index_title = "Virtus Vendas Admin"

# swagger
api_info = openapi.Info(
    title="Virtus Vendas API",
    default_version="v1",
    description="API documentation for Virtus Vendas App",
)
